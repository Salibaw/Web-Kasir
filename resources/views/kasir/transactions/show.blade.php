...
<div class="receipt-container">
    ...
    <div class="receipt-body">
        ...
        <div class="total-container">
            ...
            <p><strong>Uang Diterima: Rp{{ number_format($transactions->first()->cash_received ?? 0, 2, ',', '.') }}</strong></p>
            <p><strong>Kembalian: Rp{{ number_format($transactions->first()->cash_received - $transactions->sum('total'), 2, ',', '.') }}</strong></p>
        </div>
    </div>
    ...
    <div class="button-container">
        ...
        <a href="{{ route('kasir.transactions.pdf', ['id' => $sale->id]) }}" class="button-download">Download Struk</a>
    </div>
</div>
@endsection
